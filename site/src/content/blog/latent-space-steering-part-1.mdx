...
import TitleBackPeek from '../../components/animations/TitleBackPeek.tsx';
...
## <TitleBackPeek client:visible triggerAt={0.25}>AI that's got your Back</TitleBackPeek>
...
As <a href="https://medium.com/better-humans/how-ideas-are-formed-in-the-mind-e0607ae94097" target="_blank" rel="noopener noreferrer">Dr Gabriel Barsawme said</a>, “to be human is to come up with ideas.” And it's not just a human quirk; without new ideas, nothing moves forward. Not technology, not society, not personal growth. Even this blog post doesn't exist without them.
...
## <TitleSparkFizzle client:visible triggerAt={0.25}>In Need of A Spark</TitleSparkFizzle>
...
## <TitleNumberShuffle client:visible triggerAt={0.25}>All in on Text Embeddings</TitleNumberShuffle>
...
For instance, here is a in interactice 3D representation (go ahead and explore it) of a bunch of different text blurbs taken out of a conversation (let’s call it the **“dude conversation”**) between two guys about cars, travel, and music. I’ve highlighted some of the blurbs for illustration:
...
## <TitleThoughtGather client:visible triggerAt={0.25}>Grouping Memories for Consumption</TitleThoughtGather>
...
## <TitleDreamRipple client:visible triggerAt={0.25}>Making it Dream</TitleDreamRipple>
...
## So what<TitleQuestionClash client:visible triggerAt={0.25}>?</TitleQuestionClash>
