...
## <TitleSparkFizzle client:visible triggerAt={0.25}>The Spark</TitleSparkFizzle>
...
## <TitleNumberShuffle client:visible triggerAt={0.25}>Magic Math: Text Embeddings</TitleNumberShuffle>
...
## <TitleThoughtGather client:visible triggerAt={0.25}>Baskets of Thoughts</TitleThoughtGather>
...
## <TitleDreamRipple client:visible triggerAt={0.25}>Keep Dreamin’</TitleDreamRipple>
